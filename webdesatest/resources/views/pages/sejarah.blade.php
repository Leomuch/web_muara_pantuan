...
@section('content')
<section id="sejarah" class="relative bg-cover bg-center bg-fixed text-[#5c3b2e] py-20" style="background-image: url('{{ asset('img/bg-sejarah.jpg') }}');">
  <div class="bg-black bg-opacity-60 absolute inset-0"></div>
  <div class="relative container mx-auto px-6 z-10">
    <h2 class="text-4xl font-bold mb-6 text-center text-[#5c3b2e]">Sejarah Desa Muara Pantuan</h2>
